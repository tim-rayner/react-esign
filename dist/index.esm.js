...
const Button = ({ children, onClick, disabled, style }) => {
    return (jsx("button", { onClick: onClick, disabled: disabled, style: disabled ? undefined : style, className: "button", children: children }));
};
...
buttonType = "button", download = false, clear = true, }) => {
    ...
    const strokesRef = useRef([]); // Stores all stroke paths
    const currentStrokeRef = useRef([]); // Current stroke
    ...
    return (jsxs("div", { className: "signature-input-container", children: [jsx("canvas", { className: `drawing-canvas`, ref: signaturePadRef, width: width, height: height, style: Object.assign({ touchAction: "none" }, borderStyles()) }), jsxs("div", { style: {
                    display: "flex",
                    gap: 1,
